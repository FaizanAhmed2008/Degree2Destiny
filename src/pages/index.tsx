    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="/videos/hero-sec.mp4" type="video/mp4" />
        ...
        {/* Hero Content */}
        <div
          className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto animate-fade-in-delay-2">
              A skill-driven platform connecting ambitious students, dedicated
              professors, and HR / recruiters
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Everything you need to bridge the gap between education and career
              success
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-center">
                Identify areas for improvement with comprehensive skill
                assessments and personalized gap analysis
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-center">
                Connect with relevant opportunities that match your skills and
                career goals
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-center">
                Monitor your progress with real-time readiness scores, aptitude
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-center">
                Access detailed candidate profiles with verified skills,
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-center">
                Visualize your data with interactive charts, performance graphs,
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-center">
                Get an accurate measure of your job readiness with our
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Lead Developer and Backend Engineer
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Helper, Video Creator, and Prototype Generator
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Project Ideation and Presentation
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
                We believe that every student deserves a clear path from
                education to their dream career. Degree2Destiny bridges the gap
                between academic learning and real-world job requirements.
              </p>
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
                Our platform empowers students to track their skill development,
                enables professors to guide student progress effectively, and
                helps companies discover talented candidates based on verified
                skills and readiness scores.
              </p>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join thousands of students, professors, and companies already using
            Degree2Destiny
          </p>
