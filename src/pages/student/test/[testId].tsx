...
const TestPage: React.FC = () => {
  ...
  useEffect(() => {
    const loadTest = async () => {
      try {
        ...
        const newAttempt = await startTestAttempt(currentUser.uid, testId as string, loadedTest);
    ...
    try {
      ...
      setAttempt((prev) =>
        prev
          ? {
              ...prev,
              answers: [...prev.answers.filter((a) => a.questionId !== question.id), answer],
            }
          : null
      );
    } catch (err) {
  ...
  const handleSubmit = async () => {
    ...
    if (!window.confirm('Are you sure you want to submit the test? This cannot be undone.')) {
      return;
    }
      ...
      <ProtectedRoute requiredRole="student">
        <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-md">
            ...
            <p className="text-gray-700 dark:text-gray-300">{error || 'Failed to load test'}</p>
            <button
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-4xl mx-auto p-4">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <h4 className="font-semibold text-gray-800 dark:text-white mb-3">Question Navigator</h4>
                ...
                <button
                  ...
                  className={`p-2 rounded font-medium text-sm transition ${
                    index === currentQuestionIndex
                      ...
                      : attempt.answers.some((a) => a.questionNumber === index + 1)
