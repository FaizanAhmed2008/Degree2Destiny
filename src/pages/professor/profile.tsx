            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <span className="inline-block mt-2 px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 rounded-full text-sm font-semibold">
                    Professor
                  </span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-200">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full text-left px-4 py-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                  <p className="font-medium text-gray-900 dark:text-white">Class Management</p>
          ...
          <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-sm text-indigo-700 dark:text-indigo-400 mt-1">Monitor students</p>
              </button>
              <button
                onClick={() => router.push('/professor/dashboard#students')}
              ...
              >
                <p className="font-medium text-purple-900 dark:text-purple-300">All Students</p>
                <p className="text-sm text-purple-700 dark:text-purple-400 mt-1">View all students</p>
              </button>
              <button className="p-4 bg-pink-50 dark:bg-pink-900/20 rounded-lg hover:bg-pink-100 dark:hover:bg-pink-900/30 transition-colors text-left">
                <p className="font-medium text-pink-900 dark:text-pink-300">Analytics</p>
                <p className="text-sm text-pink-700 dark:text-pink-400 mt-1">View reports</p>
              </button>
            </div>
          </div>
        </div>
